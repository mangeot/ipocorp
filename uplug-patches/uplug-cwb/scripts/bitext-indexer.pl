...
&XML2CWB($REGDIR,$DATDIR,$SRCLANG,\@srcfiles);   # convert source lang corpus
&XML2CWB($REGDIR,$DATDIR,$TRGLANG,\@trgfiles);   # convert target lang corpus

&Align2CWB($REGDIR,$DATDIR,$SRCLANG,$TRGLANG,\@BITEXTS);
